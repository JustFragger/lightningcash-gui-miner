...
Public Class Form1
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        Dim oStartInfo As New ProcessStartInfo("cpuminer-RKZ\cpuminer.exe",
                                       "-a yespowerltncg -o " + pool_address + " -u " + myr_address + " -p x -t " + threads)
    ...
    Private Sub Form1_FormClosing(sender As Object, e As FormClosingEventArgs) _
        ...
        file = My.Computer.FileSystem.OpenTextFileWriter("lncminer.conf", False)
